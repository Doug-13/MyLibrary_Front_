  ...
  if (!friendData) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={{ color: theme.textSecondary }}>Carregando dados do usuário...</Text>
      </View>
    );
  }
...
const createStyles = (theme) =>
  StyleSheet.create({
    ...
    loadingContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12, backgroundColor: theme.bg },
    loadingText: { marginTop: 8, color: theme.textSecondary },

    // HERO
    hero: { paddingHorizontal: 16, paddingTop: 8, paddingBottom: 12, backgroundColor: theme.primary, borderBottomWidth: 1, borderBottomColor: '#F6E68B' },
    heroRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    heroTitle: { fontSize: 18, fontWeight: '800', color: theme.text },
    heroSubtitle: { marginTop: 4, fontSize: 12, color: theme.textSecondary },
    ...
    searchInput: { flex: 1, color: theme.text, paddingVertical: 0, fontSize: 14 },

    // Perfil
    profileContainer: { alignItems: 'center', paddingVertical: 16, paddingHorizontal: 12, backgroundColor: theme.bg },
    profileImageLarge: { width: 96, height: 96, borderRadius: 48, borderWidth: 2, borderColor: theme.border, backgroundColor: '#F1F5F9' },
    userName: { fontSize: 20, fontWeight: '700', marginTop: 8, color: theme.text },
    userBio: { color: theme.textSecondary, marginTop: 4, textAlign: 'center', paddingHorizontal: 16 },
    followButton: { marginTop: 12, paddingVertical: 8, paddingHorizontal: 16, backgroundColor: theme.secondary, borderRadius: 20 },
    unfollowButton: { backgroundColor: theme.error },
    followButtonText: { color: '#fff', fontWeight: '700' },

    list: { paddingHorizontal: 12 },

    sectionContainer: { marginBottom: 16 },
    sectionTitle: { fontSize: 16, fontWeight: '700', marginBottom: 8, color: theme.text },
    ...
    bookAuthor: { fontSize: 12, color: theme.textSecondary },

    bookListItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.card, borderRadius: 12, padding: 8, marginBottom: 8, marginRight: 10, borderWidth: 1, borderColor: theme.border },
    bookCover: { width: 60, height: 90, borderRadius: 6, marginRight: 10, backgroundColor: '#F1F5F9' },
    bookDetails: { flex: 1 },

    privateProfileMessage: { padding: 16, alignItems: 'center' },
    privateProfileText: { textAlign: 'center', color: theme.textSecondary },
  });
