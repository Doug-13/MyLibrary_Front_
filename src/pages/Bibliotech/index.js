...
export default function AboutScreen() {
  ...
  const styles = useMemo(() => {
    ...
    return StyleSheet.create({
      ...
      appName: { marginTop: 10, fontSize: 24, fontWeight: '800', color: theme.text },
      appTagline: { marginTop: 2, fontSize: 16, color: theme.text, opacity: 0.9 },
      scrollView: { paddingHorizontal: 16, paddingBottom: 24, paddingTop: 12 },
      card: {
        backgroundColor: theme.card,
        borderRadius: RADIUS,
      ...
      subTitle: { fontSize: 16, fontWeight: '800', color: theme.text, marginBottom: 8 },
      paragraph: { fontSize: 14, lineHeight: 22, color: theme.textSecondary },
      list: { marginTop: 8, gap: 8 },
      listItem: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 6 },
      listIconWrap: {
        width: 28,
      ...
      listText: { flex: 1, fontSize: 14, lineHeight: 20, color: theme.text },
      contactRow: {
        flexDirection: 'row',
        alignItems: 'center',
        gap: 10,
      ...
      contactText: { flex: 1, color: theme.text, fontWeight: '600' },
      link: { textDecorationLine: 'underline', color: theme.secondary, fontWeight: '700' },
      socialRow: {
        flexDirection: 'row',
        justifyContent: 'flex-start',
        gap: 10,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.list}>
            {features.map((f, idx) => (
              <View key={idx} style={styles.listItem}>
                <View style={styles.listIconWrap}>
                  <Icon name={f.icon} size={18} color={theme.text} />
                </View>
                <Text style={styles.listText}>{f.text}</Text>
              </View>
            ))}
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.contactRow} onPress={openMail} activeOpacity={0.85}>
            <View style={styles.contactIconWrap}>
              <Icon name="alternate-email" size={18} color={theme.text} />
            </View>
            <Text style={styles.contactText}>suporte@bibliotech.com</Text>
          ...
          <TouchableOpacity style={styles.contactRow} onPress={openSite} activeOpacity={0.85}>
            <View style={styles.contactIconWrap}>
              <Icon name="public" size={18} color={theme.text} />
            </View>
            <Text style={[styles.contactText, styles.link]}>www.bibliotech.com</Text>
            <Icon name="open-in-new" size={18} color={theme.textSecondary} />
          </TouchableOpacity>
